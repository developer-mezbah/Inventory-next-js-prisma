...
export default function BasicInfo({ formData, onChange, type }) {
    ...
    const handleSave = () => {
        // Mock save logic
        alert(`Units Saved: Base Unit: ${baseUnit}, Secondary Unit: ${secondaryUnit}`);
    };
    ...
    return (
        <div className="space-y-6">
            ...
            {showUnitModal && (<div className="fixed z-20 animate-in inset-0 bg-gray-900 bg-opacity-50 flex items-start justify-center p-4 pt-10 sm:pt-20">
                <div ref={dropdownRef} className="bg-white rounded-xl shadow-2xl w-full max-w-lg m-auto transform transition-all">

                    {/* Modal Header */}
                    <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50 rounded-t-xl">
                        <h2 className="text-xl font-semibold text-gray-800">Select Unit</h2>
                        <button
