...
const studentTypeData = [
  { id: 'Online Only', label: 'Online Only', value: 450, color: 'hsl(210, 70%, 50%)' },
  { id: 'Hybrid', label: 'Hybrid', value: 350, color: 'hsl(120, 70%, 50%)' },
  { id: 'In-Person', label: 'In-Person', value: 200, color: 'hsl(0, 70%, 50%)' },
];

const StudentTypeDonut = () => {
    const totalStudents = studentTypeData.reduce((sum, item) => sum + item.value, 0);
