import SpikeLineChart from '@/components/inventory/home/SpikeLineChart'
import StudentTypeDonut from '@/components/inventory/home/StudentTypeDonut'
        ...
        <main className="p-6 sm:p-10 space-y-6">
          ...
          <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                ...
                <span className="block text-gray-500">Total Receivable</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
            ...
            <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
              ...
              <div className="p-4 flex-grow">
                <div className="flex items-center justify-center h-full overflow-hidden px-4 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">
                  <StudentTypeDonut/>
                </div>
              </div>
            </div>
          ...
          <section className="text-right font-semibold text-gray-500">
            © 2026 Invertory Dashboard. All rights reserved.
          </section>
        </main>
      </div>
