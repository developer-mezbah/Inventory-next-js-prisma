        ...
        {daysInMonth.map((day, index) => {
          ...
          return (
            <div
              ...
              className={`flex items-center justify-center h-8 text-sm rounded-lg cursor-pointer transition-colors duration-100 ${isToday ? 'bg-yellow-300 font-bold' : 'hover:bg-indigo-100'} ${
...
const SummaryCard = ({ title, amount, color, isTotal = false }) => (
  <div className={`px-4 py-3 md:px-6 rounded-xl shadow-lg transition duration-300 transform hover:scale-[1.02] ${isTotal ? 'col-span-2 md:col-span-1' : ''}`} style={{ backgroundColor: color }}>
    <p className="text-sm md:text-md font-medium text-gray-800">{title}</p>
    <p className="sm:text-xl text-lg md:text-2xl font-bold text-gray-900 mt-1">{amount}</p>
  </div>
);
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-gray-50 font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 border-b pb-4">
        <h1 className="text-3xl font-bold text-gray-800 mb-4 md:mb-0">Purchase Bills</h1>
      ...
      <div className="bg-white p-4 md:p-6 rounded-xl shadow-2xl border border-gray-100">
        ...
        <div className="flex flex-wrap sm:gap-5 gap-2 mt-6">
          ...
          <div className="flex items-center justify-center text-3xl font-light text-gray-500 md:flex">+</div>
