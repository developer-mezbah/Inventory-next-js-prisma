...
const mockBusinessCategories = ['Electronics', 'Clothing', 'Food & Beverage', 'Software'];

const InputField = ({ label, id, value, onChange, placeholder = 'Enter details', type = 'text', readOnly = false }) => (
  ...
  <div className="flex justify-center mb-8">
    <div className="relative w-32 h-32">
      ...
      <div className="w-full h-full rounded-full border-4 border-blue-500/20 flex items-center justify-center">
        ...
        <div className={`w-28 h-28 rounded-full ${logoUrl ? 'bg-gray-200' : 'bg-blue-50'} flex items-center justify-center text-center p-2`}>
          {logoUrl ? (
            <img src={logoUrl} alt="Business Logo" className="w-full h-full object-cover rounded-full" />
          ) : (
            <span className="text-blue-700 font-semibold text-sm">Add Logo</span>
          )}
        </div>
      </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-6">
            ...
            <div className="space-y-6">
              <h2 className="text-lg font-bold text-gray-900 border-b pb-2">Business Details</h2>
              <InputField
                label="Business Name"
                id="businessName"
            ...
            <div className="space-y-6">
              <h2 className="text-lg font-bold text-gray-900 border-b pb-2">More Details</h2>
              <SelectField
                label="Business Type"
                id="businessType"
            ...
            <div className="space-y-6">
              <h2 className="text-lg font-bold text-gray-900 border-b pb-2">Business Address</h2>
              <div className="flex flex-col space-y-1">
                <textarea
                  id="businessAddress"
                  rows="4"
              ...
              <SignatureUploader onUploadClick={() => handleFileUpload('signature')} />
            </div>
